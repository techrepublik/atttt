...
{
    public partial class BackupRestoreDBForm : Form
    {
        Server srv;
        ServerConnection conn;

        public BackupRestoreDBForm()
        {
            InitializeComponent();
        }

        private void BackupRestoreDBForm_Load(object sender, EventArgs e)
        {
        ...
        private void btnBrowse_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                var sd = new SaveFileDialog
                             {
                                 InitialDirectory =
                                     Application.StartupPath + "\\DTRDbaseBak" +
                                     DateTime.Today.ToString("MM-dd-yyy") + ".bak",
                                 Filter = "bak files (*.bak)|*.bak",
                                 FilterIndex = 1,
                                 RestoreDirectory = true
                             };
